...
public class DeleteController {
	...
	public String checkDelete(Integer empId, Model model) {
		...
		Employee employee = deleteEmployeeService.findById(empId);

		// 部署情報を取得
		Department department = searchForDepartmentByDeptIdService.findByDeptId(employee.getDeptId());
	...
	public String completeDelete(Integer empId) {
		...
		deleteEmployeeService.deleteById(empId);
